...
| `-StoreName` | `System.String[]` | `Root` | `Root`, `CA` | One or more stores to export. `CA` also exports intermediates and emits a trust-expansion warning. `Disallowed` is always read separately and subtracted. |
